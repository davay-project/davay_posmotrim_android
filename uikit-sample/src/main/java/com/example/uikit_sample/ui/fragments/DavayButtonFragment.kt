...
import com.example.uikit_sample.ui.viewmodels.DavayButtonViewModel
...
class DavayButtonFragment : Fragment() {
    ...
    private lateinit var viewModel: DavayButtonViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(DavayButtonViewModel::class.java)
